...
"Grishma Gairhe". No code in this file is copied from any other source
...
Semester: Fall 2024
Description: ggairhe-Assignment 1
'''
...
def before(date: str) -> str:
    ...
    if day == 0:  # If the day becomes zero, back to the previous month
        mon -= 1
